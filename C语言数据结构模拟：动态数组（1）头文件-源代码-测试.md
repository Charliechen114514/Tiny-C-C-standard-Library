...
date: 2023-02-07 14:52:56
tags: C/C++
comments: false
mathjax: true
copyright_info: 全体目光向我看齐，我宣布个事！是我Charliechen写的这篇文章！(?)
---

# 动态数组（1）源代码阅读+注释

#### 开个大坑先：后续会补上关于动态数组的API实现的文章和详解，可以先看看源代码（干了很久（大哭））

​		请注意：使用和调用环境为C语言环境，不！要！用！在！CPP文件里！函数指针返回逻辑不一样lol
